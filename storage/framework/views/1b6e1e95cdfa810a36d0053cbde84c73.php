...
<aside class="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <a href="<?php echo e(route('teams.index')); ?>" class="sidebar-link <?php echo e(request()->routeIs('teams.*') ? 'active' : ''); ?>">
...
</html><?php /**PATH C:\Users\Maryam Sohail\Downloads\teamtasks_2\teamtasks\resources\views/layouts/app.blade.php ENDPATH**/ ?>